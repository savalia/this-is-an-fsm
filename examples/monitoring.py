...
Start from "Monitoring", trigger the next expected event ('stop') and return the resulting state.
"""
from loader import load_fsm_from_json

CONFIG_PATH = "fsm_config.json"

def run(start_state_name: str = "Monitoring") -> str:
